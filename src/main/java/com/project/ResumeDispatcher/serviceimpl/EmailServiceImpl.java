package com.project.ResumeDispatcher.serviceimpl;
...
public class EmailServiceImpl implements EmailService {
    ...
    public String sendMailWithAttachment(EmailDetails details) throws IOException
    {
        ...
        try {
            ...
            FileSystemResource file = new FileSystemResource(new File("src/main/resources/static/Balaji_Dontul_Resume.pdf"));
